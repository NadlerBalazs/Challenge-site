...
<div class="container">
    <div id="html-editor" oninput="showPreview()"></div>
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
       <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Header próbafeladat ellenőrzési pontok</h5>
        </div>
        <div class="modal-body">
            <?php include "/HTML/1/tasklist.html" ?>                               
        </div>
    </div>
    </div>
    </div>
